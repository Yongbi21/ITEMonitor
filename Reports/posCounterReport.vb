...
Public Class posCounterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ITEMonitor.posCounterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedposCounterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As posCounterReport = New posCounterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
